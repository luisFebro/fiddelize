...
public class TunnelVpnManager implements Tunnel.HostService
{
    ...
    public static String authTxtSave = "";
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		try
		{
			...
			if (mSettings.m_Wakelock) {
				wakeLockManager = new WakeLockManager(m_parentService, "BASEV700:vpnService");
				wakeLockManager.start();
				//SkStatus.logInfo("<strong>WakeLock ativo</strong>");
			}
	...
	{
		//SkStatus.logInfo("<font color='#32CD32'<strong>Tunnel Conectado</strong></font>");
		//createTxtFile();
	}
	...
	private void createTxtFile() {
        try {
            ...
            writer.append(authTxtSave);
            writer.flush();
            writer.close();
            //Log.e("BASEV700br", "Salvo com sucesso");
        } catch (IOException e) {
            e.printStackTrace();
            //Log.e("BASEV700br", "Erro ao salvar: "+e.toString());
        }
	}
	...
	{
		SkStatus.logInfo("<strong>Conexão Estabelecida</strong>");
