...
export const createBooking = async (dispatch, objToSend, staffId) => {
    // L
    try {
        return await axios.post(
            `/api/staff-booking/${staffId}`,
            objToSend,
            getHeaderJson
        );
    } catch (err) {
...
export const removeBooking = async (dispatch, staffId, itemId) => {
    // L
    try {
        return await axios.put(
            `/api/staff-booking/remove/${staffId}?removedId=${itemId}`,
            getHeaderJson
        );
    } catch (err) {
        return err.response;
...
export const updateBooking = async (dispatch, objToSend, bookingId) => {
    // L
    try {
        return await axios.put(
            `/api/staff-booking/${bookingId}`,
            objToSend,
            getHeaderJson
        );
    } catch (err) {
...
export const checkStatusAndUpdateMany = async (dispatch, _staffId) => {
    // L
    try {
        return await axios.put(
            `/api/staff-booking/status/${_staffId}`,
            getHeaderJson
        );
    } catch (err) {
        return err.response;
...
// LISTS
export const getStaffBookingList = async (
    dispatch,
    staffId,
    docsToSkip,
    needReadMore = false,
...
export const getStaffBookingListForAdmin = async (
    dispatch,
    staffId,
    docsToSkip,
    needReadMore = false,
