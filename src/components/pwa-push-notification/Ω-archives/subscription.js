                ...
                registration.pushManager
                    ...
                    .then((existedSubscription) => {
                        if (existedSubscription === null) {
                            console.log(
                                "No subscription detected, making a request."
                            );
                            registration.pushManager
                                .subscribe({
                                ...
                                .catch((e) => {
                                    if (Notification.permission === "denied") {
                                        console.log(
                                            "Permission was not granted. User clicked on BLOCK BTN"
                                        );
                                    } else if (
                                        Notification.permission === "denied"
                                    ) {
                                        console.log(
                                            "Permission was not granted. User clicked on X to IGNORE THE PROMPT"
                                        );
                                    } else {
                                        console.error(
