 ...
 */
export default function pluginAxisTitle(Chartist) {
    var axisDefaults = {
        axisTitle: "",
        ...
        return function ctAxisTitle(chart) {
            chart.on("created", function (data) {
                ...
                var xPos,
                    yPos,
                    title,
                    chartPadding = Chartist.normalizePadding(
                        data.options.chartPadding
                    ); // normalize the padding in case the full padding object was not passed into the options
