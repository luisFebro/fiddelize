...
const AsyncScoreDiscount = Load({ loader: () => import('./ScoreDiscount_art3' /* webpackChunkName: "instru-article-page-lazy" */)});
const AsyncWhySMS = Load({ loader: () => import('./WhySMS_art4' /* webpackChunkName: "instru-article-page-lazy" */)});
