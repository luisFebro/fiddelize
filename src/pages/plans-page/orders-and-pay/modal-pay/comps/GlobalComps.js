...
const ShowPayWatermarks = ({ needAnima = true, isPix = false }) => {
    const protectedBySrc = isPix
        ? "/img/icons/pay/logo-banco-central-white.png"
        : "/img/icons/pay/logo-pagseguro-uol.png";
