...
// support real time chat and replace Whatsapp up to 10 dez (DONE at 16 dez)
// final tests - check with Brena`s phone if the updates are fixed and her app can receive updates up to 11 dez (DONE)
// MARKETING PHASE
// create visit card and board to present to Lucas up as well make available digital images for cli-admin in for their marketing with sharing options to 15 Dez (DONE)
...
const updateDescription = "chat 2.0 with Fidda Bot training pt4";
/* HISTORY
