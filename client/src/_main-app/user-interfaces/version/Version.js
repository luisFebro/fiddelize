...
const latestVersion = "3.7510.4";
// PRÓXIMO:
//
const updateDescription =
    "app da equipe - serviço novvos membros - equipe dash - sistema multi-conta (final: atualizar todo sistema back novo User model) pt14";
const history = [
