...
const latestVersion = "3.1703.2"
const updateDescription = "Otimização completa do algoritmo do histórico de compra || otimização UI sessão histórico de compras pt 5 (finalizado backend)";
const history = [
