...
const latestVersion = "3.25.3"
const updateDescription = "Lista Automática de Tarefas - opção de excluir card se prêmio expirado (finalizado) || painel - sessão design - botão revelar prêmios e metas para clientes? (sempre revelado ou escondido durante desafios) - pt 6";
const history = [
