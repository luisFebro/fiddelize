...
const msg = (typeAndMsgName, customized = "NeedCustomWord", options) => {
    ...
    error.cpfAlreadyRegistered =
        "Não foi possível cadastrar com esse CPF nesta conta"; // Security Vulnability - do not narrow down about each issue was rejected: Esse CPF já foi registrado. Tente um outro.
    // END MESSAGES
